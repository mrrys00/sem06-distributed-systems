...
async def run_stream(id_to_subscribe: str, client_name: str or None = None) -> None:
    async with grpc.aio.insecure_channel("localhost:9000") as channel:
        ...
        if client_name != None:
            ...
            hello_stream = stub.Subscribe(
                grpcproject_pb2.SubscribeRequest(subscribtion_id=id_))
        while True:
            try:
